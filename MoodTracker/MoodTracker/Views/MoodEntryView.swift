...
struct MoodEntryView: View {
    ...
    private var noteView: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text(viewModel.mode == MoodEntryViewModel.ViewMode.edit() ? "Update your thoughts" : "What's on your mind?")
                .font(.subheadline)
                .foregroundColor(Color.theme.bodyText.opacity(0.7))
    ...
    private var actionButton: some View {
        Button(action: handleSave) {
            HStack {
                Image(systemName: viewModel.mode == MoodEntryViewModel.ViewMode.edit() ? "checkmark.circle" : "plus.circle.fill")
                Text(viewModel.mode == MoodEntryViewModel.ViewMode.edit() ? "Update Mood" : "Save Mood")
                    .fontWeight(.semibold)
            }
    ...
    private var successOverlay: some View {
        Text(viewModel.mode == MoodEntryViewModel.ViewMode.edit() ? "Mood updated successfully!" : "Mood saved successfully!")
    ...
    private var navigationTitle: String {
        viewModel.mode == MoodEntryViewModel.ViewMode.edit() ? "Edit Mood" : "Add Mood"
    }
    ...
    private func handleSave() {
        if viewModel.mode == MoodEntryViewModel.ViewMode.edit() {
