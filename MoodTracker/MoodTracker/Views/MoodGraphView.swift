...
struct MoodGraphView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            // Always refresh data when view appears (handles return from NavigationLink)
            viewModel.fetchMoodEntries(by: selectedMonth.rawValue)
            viewModel.hasEnoughData(on: selectedMonth.rawValue)
